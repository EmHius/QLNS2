                        ...
                        <div data-repeater-item="">
                            <div class="row">
                                ...
                                <div class ="mb-3 col-lg-12 col-xl-1 col-12 mb-0 d-flex align-items-center">
                                    ...
                                    <asp:Button ID="dsnv" class="btn btn-primary" runat="server" Text="..." Width="52px" Height="39px" />
                                </div>
                                <div class ="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                ...
                                <div class ="mb-3 col-lg-12 col-xl-1 col-12 mb-0 d-flex align-items-center">
                                    <asp:Button ID="dskt" class="btn btn-primary" runat="server" Text="..." Width="52px" Height="40px" />
                                </div>
                                <div class ="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                            ...
                            <div class="row">
                                ...
                                <div class ="mb-3 col-lg-12 col-xl-1 col-12 mb-0 d-flex align-items-center">
                                    <asp:Button ID="dskl" class="btn btn-primary" runat="server" Text="..." Width="52px" Height="40px" />
                                </div>
                                <div class ="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                            ...
                            <div class="row">
                                ...
                                <div class ="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                    <asp:Button ID="ht" class="btn btn-primary" runat="server" Text="Hiển thị"  Height="40px" />
                                </div>
                                <div class ="mb-3 col-lg-12 col-xl-1 col-12 mb-0">
                                </div>
                                <div class ="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                    <asp:Button ID="tinhluong" class="btn btn-primary" runat="server" Text="Tính" Height="40px" />
                                </div>
                            </div>
                            <br />
                            ...
                            <div class="row">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" Width="1158px">
                                    <Columns>
                            ...
                            <div class="row">
                                ...
                                <div class ="mb-3 col-lg-6 col-xl-2 col-12 mb-0">
                                    <asp:Button ID="themluong" class="btn btn-primary" runat="server" Text="Thêm" />
                                </div>
                                <div class ="mb-3 col-lg-6 col-xl-2 col-12 mb-0">
                                    <asp:Button ID="moi" class="btn btn-primary" runat="server" Text="Làm mới" />
                                </div>
                                <div class ="mb-3 col-lg-6 col-xl-2 col-12 mb-0">
                                    <asp:Button ID="excel" class="btn btn-primary" runat="server" Text="Excel" />
                                </div>
                            </div>
                        </div>
                    </div>
...
<asp:Panel class="container-xxl flex-grow-1 container-p-y" ID="Panel1" runat="server" Direction="LeftToRight" ScrollBars="Auto" >
    <div>
        <div class="col-12">
            <div class="card">
                ...
                <div class="row">
                    ...
                    <div class ="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                        <asp:Button ID="chonnv" class="btn btn-primary" runat="server" Text="Chọn nhân viên" />
                    </div>
                </div>
                <div class="row">
                    <div class ="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                    ...
                    <div class ="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                        <asp:Button ID="Button1" class="btn btn-primary" runat="server" Text="Chọn nhân viên" />
                    </div>
                </div>
                <div class="row">
                    <asp:GridView ID="dsnv1" runat="server" AutoGenerateColumns="False" AutoGenerateSelectButton="True" Width="527px" OnSelectedIndexChanged="dsnv1_SelectedIndexChanged">
                        <Columns>
                            <asp:BoundField DataField="MaNhanVien" HeaderText="Mã nhân viên" SortExpression="MaNhanVien" />
